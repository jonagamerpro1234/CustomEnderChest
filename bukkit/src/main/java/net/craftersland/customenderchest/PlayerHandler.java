...
public class PlayerHandler implements Listener {
    ...
    @EventHandler
    public void onCmd(@NotNull ServerCommandEvent event) {
    ...
    @EventHandler
    public void onCmd(@NotNull PlayerCommandPreprocessEvent event) {
    ...
    @EventHandler
    public void onPlayerJoinEvent(final @NotNull PlayerJoinEvent e) {
        enderchest.getDataHandler().addJoinDelay(e.getPlayer());
        Bukkit.getScheduler().runTaskLaterAsynchronously(enderchest, () -> {
    ...
    @EventHandler
    public void onPlayerDisconnectEvent(@NotNull PlayerQuitEvent e) {
        enderchest.getDataHandler().removeJoinDelay(e.getPlayer());
